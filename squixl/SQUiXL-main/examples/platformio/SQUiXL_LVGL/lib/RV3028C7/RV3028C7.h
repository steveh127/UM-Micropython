...
class RV3028C7
{
	public:
		...
		void getCurrentTimeComponents(uint8_t *seconds, uint8_t *mins, uint8_t *hours);

		void getCurrentDateComponents(uint8_t *day_week, uint8_t *day_month, uint8_t *month, uint8_t *year);
	...
	private:
		...
		uint8_t _dateTimeCached[DATETIME_COMPONENTS];
		TwoWire *_i2cPort;
